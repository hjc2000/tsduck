...
namespace ts
{
	...
	namespace names
	{
		...
		//!
		TSDUCKDLL UString TID(DuckContext const &duck, uint8_t tid, uint16_t cas = CASID_NULL, NamesFlags flags = NamesFlags::NAME);
		...
		//! @return The corresponding name.
		//!
		TSDUCKDLL UString CASId(DuckContext const &duck, uint16_t casid, NamesFlags flags = NamesFlags::NAME);
		...
		//! @return The corresponding name.
		//!
		TSDUCKDLL UString Content(DuckContext const &duck, uint8_t c, NamesFlags flags = NamesFlags::NAME);
