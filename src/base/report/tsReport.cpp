...
ts::Enumeration const ts::Severity::Enums({
...
void ts::Report::log(int severity, UString const &msg)
{
...
void ts::Report::log(int severity, UChar const *fmt, std::initializer_list<ArgMixIn> args)
{
	if (severity <= _max_severity)
	{
...
void ts::Report::log(int severity, UString const &fmt, std::initializer_list<ArgMixIn> args)
{
	if (severity <= _max_severity)
	{
		log(severity, UString::Format(fmt, args));
