...
namespace ts
{
	...
	public:
		...
		//!
		ErrCodeReport(Report &report, UString const &message = UString(), UString const &object = UString(), int severity = Severity::Error)
			: _report(&report),
			  _message(message),
			  _object(object),
			  _severity(severity)
		...
		//! @param [in] severity Severity at which the message is reported (default: error).
		//!
		ErrCodeReport(bool &success, Report &report, UString const &message = UString(), UString const &object = UString(), int severity = Severity::Error)
			: _success(&success),
			  _report(&report),
			  _message(message),
			  _object(object),
		...
		ErrCodeReport(Report &report, UChar const *message, UString const &object = UString(), int severity = Severity::Error)
			: _report(&report),
			  _message(message),
			  _object(object),
			  _severity(severity)
		...
		ErrCodeReport(Report &report, UChar const *message, UChar const *object, int severity = Severity::Error)
			: _report(&report),
			  _message(message),
			  _object(object),
			  _severity(severity)
		...
		ErrCodeReport(Report &report, UChar const *message, fs::path const &object, int severity = Severity::Error)
			: _report(&report),
			  _message(message),
			  _object(object.string()),
			  _severity(severity)
		{
		}

		ErrCodeReport(Report &report, UString const &message, fs::path const &object, int severity = Severity::Error)
			: _report(&report),
			  _message(message),
			  _object(object.string()),
			  _severity(severity)
		...
		ErrCodeReport(bool &success, Report &report, UChar const *message, UString const &object = UString(), int severity = Severity::Error)
			: _success(&success),
			  _report(&report),
			  _message(message),
			  _object(object),
		...
		ErrCodeReport(bool &success, Report &report, UChar const *message, UChar const *object, int severity = Severity::Error)
			: _success(&success),
			  _report(&report),
			  _message(message),
			  _object(object),
		...
		ErrCodeReport(bool &success, Report &report, UChar const *message, fs::path const &object, int severity = Severity::Error)
			: _success(&success),
			  _report(&report),
			  _message(message),
			  _object(object.string()),
		...
		ErrCodeReport(bool &success, Report &report, UString const &message, fs::path const &object, int severity = Severity::Error)
			: _success(&success),
			  _report(&report),
			  _message(message),
			  _object(object.string()),
