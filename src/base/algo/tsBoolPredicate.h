...
namespace ts
{
	...
	//!
	TSDUCKDLL inline bool Identity(bool arg)
	{
		return arg;
	}
	...
	//! @return Not @a arg.
	//!
	TSDUCKDLL inline bool Not(bool arg)
	{
		return !arg;
	}
	...
	//!
	TSDUCKDLL inline bool And(bool arg1, bool arg2)
	{
		return arg1 && arg2;
	}
	...
	//!
	TSDUCKDLL inline bool Or(bool arg1, bool arg2)
	{
		return arg1 || arg2;
	}
	...
	//!
	TSDUCKDLL inline bool Nand(bool arg1, bool arg2)
	{
		return !(arg1 && arg2);
	}
	...
	//!
	TSDUCKDLL inline bool Nor(bool arg1, bool arg2)
	{
		return !(arg1 || arg2);
	}
	...
	//!
	TSDUCKDLL inline bool Xor(bool arg1, bool arg2)
	{
	...
	//!
	TSDUCKDLL inline bool MultiNand(std::initializer_list<bool> args)
	{
		return !MultiAnd(args);
	}
	...
	//!
	TSDUCKDLL inline bool MultiNor(std::initializer_list<bool> args)
	{
		return !MultiOr(args);
	}
} // namespace ts
