...
namespace ts
{
	...
	bool EnumerateCombinations(std::set<T> const &values,
							   std::set<T> const &fixed,
							   size_t size,
	...
	bool Contains(std::vector<VALUE> const &container, const VALUE &value)
	{
...
//!
template <class OSTREAM, class PARAM, class TRAITS = std::char_traits<typename OSTREAM::char_type>>
std::basic_ostream<typename OSTREAM::char_type, TRAITS> &operator<<(std::basic_ostream<typename OSTREAM::char_type, TRAITS> &strm, ts::IOManipulatorProxy<OSTREAM, PARAM, TRAITS> const &proxy)
{
...
template <typename T, class UnaryPredicate>
bool ts::EnumerateCombinations(std::set<T> const &values,
							   std::set<T> const &fixed,
							   size_t size,
							   UnaryPredicate predicate)
{
